<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/masterPage.Master" CodeBehind="display.aspx.vb" Inherits="Gayandn.display" %>
...
, isNUll(t_main.approved,'N/A') AS  approved , isNULL(t_sysUsers.f_name,'N/A') AS f_name, isNULL(t_city.c_name,'N/A') AS c_name, t_main.SysUser_fkey, t_main.city_fkey FROM t_main INNER JOIN t_city ON t_main.city_fkey = t_city.c_id INNER JOIN t_sysUsers ON t_main.SysUser_fkey = t_sysUsers.sysUser_id 
WHERE p_id=@p_id"  >
                <SelectParameters>
	...
	<hr />
				...
				<table class="table table-bordered">
					...
					<tbody>
						...
						<td>Details</td>
							<td>       <asp:Label ID="Labelpdate" runat="server" Text=""></asp:Label></td>
						</tr>
